    ...
    <v-container>
      <v-row dense>
        ...
        >
          <v-card>
            <v-img
                :src="v.is_dynamic_cover ? v.dynamic_cover_urls[0] : v.dynamic_cover_urls[0].replace(/obj/g, '').replace(/~(.*)/g, '') + '~tplv-yykgsuqxec-imagexlite-61c10ff8ccdc26b60d901eaa5b1864f0.jpg'"
